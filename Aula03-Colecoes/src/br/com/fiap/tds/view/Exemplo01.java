...
public class Exemplo01 {
	...
	public static void main(String[] args) {
		...
		//Adicionar um elemento String na lista
		...
		if (!lista.isEmpty()) {
			...
			System.out.println(lista.get(2)); //ES
		...
		//item é um parâmetro do método, que representa um item da lista, do outro lado da seta é a função
